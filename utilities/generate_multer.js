  ...
  return multer({
    storage: multer.diskStorage({
      destination: function (req, file, cb) {
        const imagePath = path.join(path.resolve(''), 'assets', `${assetType}`, `${req.body.username ? req.body.username : req.params.username}`);
      ...
      filename: function (req, file, cb) {
        ...
        cb(null, `${req.body.username || req.params.username}_${formattedDate}_${file.originalname}`);
      }
    }),
